...
import club.kingon.flink.connectors.redis.common.mapper.impl.DefaultRedisStringMapper;
...
public class RedisStringExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkJedisPoolConfig conf = new FlinkJedisPoolConfig.Builder()
                ...
                .build();
        stream.addSink(new RedisSink<>(conf, new DefaultRedisStringMapper(600)));
